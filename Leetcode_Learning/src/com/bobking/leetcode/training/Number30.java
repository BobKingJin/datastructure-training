...
public class Number30 {
    ...
    // 同理可参考：https://leetcode-cn.com/problems/substring-with-concatenation-of-all-words/solution/chuan-lian-suo-you-dan-ci-de-zi-chuan-by-powcai/
            ...
            for (int i = j; i < s.length() - wordNum * wordLen + 1; i = i + wordLen) {
                ...
                while (num < wordNum) {
                    ...
                    if (allWords.containsKey(word)) {
                        ...
                        // 但其实这里只是移动到了出现问题单词的地方，因为最外层有 for 循环，
                        // i 还会移动一个单词，然后刚好就移动到了单词后边
                    } else {
                        hasWords.clear();
                        i = i + num * wordLen;
                        num = 0;
