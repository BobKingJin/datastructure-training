...
public class Number803 {
    ...
    // 参考：https://leetcode.cn/problems/bricks-falling-when-hit/solution/803-da-zhuan-kuai-by-leetcode-r5kf/
    public int[] hitBricks(int[][] grid, int[][] hits) {
        ...
        // 其余网格，如果是砖块向上、向左查一下，如果也是砖块，在并查集中进行合并
        ...
        for (int i = hitsLen - 1; i >= 0; i--) {
            ...
            // 注意：如果补回的这个节点在第 1 行，要告诉并查集它与屋顶相连（逻辑同第 2 步）
            if (x == 0)
