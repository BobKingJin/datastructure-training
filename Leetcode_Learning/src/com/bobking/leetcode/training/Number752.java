...
public class Number752 {
    ...
    // 参考：https://leetcode.cn/problems/open-the-lock/solution/gong-shui-san-xie-yi-ti-shuang-jie-shuan-wyr9/
        ...
        while (m-- > 0) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                for (int j = -1; j <= 1; j++) {
                    ...
                    // 例如 origin = 0，j = -1，即 next = -1，意味着方向 0 拨向 9
                    if (next == -1)
                        next = 9;
