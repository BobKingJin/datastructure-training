...
public class Number113 {
    ...
    // 先序遍历
    private void dfs1(TreeNode root, int targetSum, List<Integer> list,
    ...
    public List<List<Integer>> pathSum2(TreeNode root, int targetSum) {
        List<List<Integer>> result = new ArrayList<List<Integer>>();
        dfs2(root, targetSum, 0, new ArrayList<Integer>(), result);
        return result;
    }

    public void dfs2(TreeNode root, int targetSum, int toal, List<Integer> list,
        List<List<Integer>> result) {
        ...
        dfs2(root.left, targetSum, toal, list, result);
        dfs2(root.right, targetSum, toal, list, result);
        list.remove(list.size() - 1);
    }
